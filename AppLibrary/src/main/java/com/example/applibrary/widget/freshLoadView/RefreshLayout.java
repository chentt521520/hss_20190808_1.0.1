package com.example.applibrary.widget.freshLoadView;
...
import com.example.applibrary.widget.freshLoadView.footView.LoadingFooterView;
import com.example.applibrary.widget.freshLoadView.freshUtils.DensityUtil;
import com.example.applibrary.widget.freshLoadView.headerView.RefreshHeaderView;
import com.example.applibrary.widget.freshLoadView.processor.AnimProcessor;
import com.example.applibrary.widget.freshLoadView.processor.IDecorator;
import com.example.applibrary.widget.freshLoadView.processor.OverScrollDecorator;
import com.example.applibrary.widget.freshLoadView.processor.RefreshProcessor;

import static android.support.v4.widget.ViewDragHelper.INVALID_POINTER;


/**
 * @author chentt on 16/3/2.
 */
public class RefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    public RefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMaxHeadHeight = DensityUtil.dip2px(context, 100);
        mHeadHeight = DensityUtil.dip2px(context, 70);
        mMaxBottomHeight = DensityUtil.dip2px(context, 100);
        mBottomHeight = DensityUtil.dip2px(context, 60);
        mOverScrollHeight = mHeadHeight;
        enableRefresh = true;
        enableLoadmore = true;
        isPureScrollModeOn = false;
        isOverScrollTopShow = true;
        isOverScrollBottomShow = true;
        enableOverScroll = true;
        floatRefresh = false;
        autoLoadMore = false;
        enableKeepIView = true;
        showRefreshingWhenOverScroll = true;
        showLoadingWhenOverScroll = true;
    ...
    private void addHeader() {
        ...
        if (mHeadView == null) {
            mHeadView = new RefreshHeaderView(getContext());
    ...
    private void addFooter() {
        ...
        if (mBottomView == null) {
            mBottomView = new LoadingFooterView(getContext());
    ...
    public class CoContext {
        ...
        public void init() {
            if (isPureScrollModeOn) {
                ...
                if (mHeadLayout != null) mHeadLayout.setVisibility(View.GONE);
                if (mBottomLayout != null) mBottomLayout.setVisibility(View.GONE);
            }
        }
